...
"s"==a&&null!=localStorage.getItem("orginalTeacherId")&&(localStorage.removeItem("orginalTeacherId"),null!=localStorage.getItem("teacherId")&&localStorage.removeItem("teacherId"))},canvasEnabelWhenRefresh:function(){null!=localStorage.getItem("teacherId")&&a.utility.makeCanvasEnable()},arrayContainsSameValue:function(a,c){for(var d=0;d<c.length;d++)if(c[d]!==a)return!1;return!0},actionAfterRemovedUser:function(){a.utility.makeCanvasDisable();a.utility.setStyleUserConnetion("con","coff");a.utility.removeVirtualWindow("virtualWindow");
a.user.connected=!1;localStorage.removeItem("otherRole");"undefined"!=typeof cthis&&(tempIsInitiaor=!0,cthis.isStarted&&cthis.handleRemoteHangup())},sendRequest:function(b,c){a.utility.beforeSend({reclaimRole:!0})},updateSentInformation:function(b,c){if(a.utility.chkValueInLocalStorage("orginalTeacherId")){var d=JSON.parse(b),d="undefined"!=typeof c?d:d.repObj[0],f="",k;for(k in d)f+=k+" : "+d[k]+" <br />";null!=document.getElementById("sentMsgInfo")&&(document.getElementById("sentMsgInfo").innerHTML=
f)}},beforeSend:function(b){var c=JSON.stringify(b);b.hasOwnProperty("createArrow")?"undefined"==typeof optimizObj?optimizObj=optimization():optimizObj.sendPacketWithOptimization(c,io.sock.readyState,100):(a.sentPackets+=c.length,1==io.sock.readyState&&io.send(b),JSON.parse(c).hasOwnProperty("repObj")&&a.utility.updateSentInformation(c));localStorage.sentPackets=a.sentPackets},checkCanvasHasParents:function(){for(var a=document.getElementById("vcanvas");"BODY"!=a.parentNode.tagName;)"vcanvas"!=a.id&&
(a.style.margin="0",a.style.padding="0"),a=a.parentNode;"vcanvas"!=a.id&&(a.style.margin="0",a.style.padding="0")},lockCanvas:function(){if(g.earlierWidth!=g.innerWidth&&(a.canvasDisable=!0,a.utility.makeCanvasDisable(),a.utility.toolWrapperDisable(),null==document.getElementById("divForReloadMsg"))){var b=null!=localStorage.getItem("teacherId")?"msgForReload":"msgStudentForReload";g.whBoard.view.displayMsgBox("divForReloadMsg",b);g.earlierWidth=g.innerWidth}},getElementRightOffSet:function(a){var c=
20;null!=a.parentNode&&(a=a.parentNode,c=vcan.utility.getElementOffset(a),c=g.innerWidth-(a.clientWidth+(c.x-0)));return c}}})(window);(function(g){g.whBoard.lang.message={notSupportCanvas:'This browser does not support Canvas. Please update your browser with the latest versionFor more information about Canvas, click on the link given here <a href="http://en.wikipedia.org/wiki/Canvas_element/">Canvas</a>',notSupportGetUserMedia:'The browser does not support getUserMedia for webRtc. Please update your browser with the latest version For more information about getUuserMedia, click on the link given here <a href="http://dev.w3.org/2011/webrtc/editor/getusermedia.html">getUserMedia</a>',
