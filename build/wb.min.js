...
(vApp.wb.utility.setOrginalTeacherContent(b),f.vApp.wb.attachToolFunction(vcan.cmdWrapperDiv,!0)):"s"==a&&null==c&&(vcan.studentId=wbUser.id,null==localStorage.getItem("studentId")&&localStorage.setItem("studentId",wbUser.id));1==d?(vApp.gObj.video.init(),vApp.gObj.video.isInitiator=!0,vcan.oneExecuted=!1):2<=d&&null==c&&(console.log("browser number "+d),vcan.oneExecuted=!1,vApp.gObj.video.init())},checkWebRtcConnected:function(){return"undefined"==typeof cthis||!cthis.pc[0].hasOwnProperty("iceConnectionState")&&
...
displayCanvas:function(){f.vApp.wb.attachToolFunction(vcan.cmdWrapperDiv);f.vApp.wb.init();vApp.wb.utility.makeCanvasDisable();vApp.wb.utility.toolWrapperDisable()},initAll:function(b){null!=localStorage.getItem("teacherId")&&vApp.wb.utility.makeCanvasDisable();vApp.system.measureResoultion({width:f.outerWidth,height:f.innerHeight})},alreadyExistToolBar:function(){var b=document.getElementById("t_rectangle");if(null!=b)return 8<=b.parentNode.getElementsByClassName("tool").length?!0:!1},alreadyExistPacketContainer:function(){var b=
...
!0:c.utility.clickOutSidebox(c.obj.drawTextObj.textWriteMode)&&g.optimize.calculatePackets(h,"d",d.startPosX,d.startPosY),a.detail.hasOwnProperty("cevent")?a.detail.cevent.hasOwnProperty("mtext")?c.obj.drawTextObj.textUtility(d.startPosX,d.startPosY,a.detail.cevent.mtext):c.obj.drawTextObj.textUtility(d.startPosX,d.startPosY):c.obj.drawTextObj.textUtility(d.startPosX,d.startPosY)}"freeDrawing"==b&&!0==c.obj.freeDrawObj.freesvg&&c.obj.freeDrawObj.drawStart(a)};d.mousemove=function(a,f){a.detail.hasOwnProperty("cevent")&&
...
_render:function(a){var b,d=0;b=0;for(var h=-(this.width/2),f=-(this.height/2),m=0,l=this.path.length;m<l;++m)switch(b=this.path[m],b[0]){case "L":d=b[1];b=b[2];a.lineTo(d+h,b+f);break;case "M":d=b[1],b=b[2],a.moveTo(d+h,b+f)}},replay_render:function(a,b,d,h){var f=y=0;switch(b[0]){case "L":f+=b[1];y+=b[2];a.lineTo(f+d,y+h);a.stroke();break;case "M":f+=b[1],y+=b[2],a.moveTo(f+d,y+h)}},render:function(a,d){a.save();var g=this.transformMatrix;g&&a.transform(g[0],g[1],g[2],g[3],g[4],g[5]);d||b.transform(a,
...
b.interact.scaleObject(e,c,"y");else if(d.currentTransform.target.draggable){var g=b.extend({},b.main.currentTransform.target);(new Date).getTime();!0==d.currentTransform.target.downObj&&(b.main.dragMode=!0,d.currentTransform.target.downObj=!1);g=b.interact.translateObject(e,c);a.detail.hasOwnProperty("cevent")||b.optimize.doOptiMize(a);g.setActive(!0);g.setCoords()}if("scaleX"===d.currentTransform.action||"scaleY"===d.currentTransform.action||"rotate"===d.currentTransform.action&&!d.currentTransform.target.hasRotatingPoint)b.main.scaleMode=
...
d;this.currTextObjWrapper=b;this.prevTextObj.measure=b},renderText:function(b,a,d,c){var e=vApp.wb.vcan;if(""!=this.prevTextObj){if(!vApp.wb.utility.IsObjEmpty(b))for(var g=0;g<e.main.children.length;g++)if(b.id==e.main.children[g].id){e.main.children.splice(g,1);this.currObject="";break}vApp.wb.utility.IsObjEmpty(b)?"undefined"!=typeof c?this.finalizeText(d,this.prevTextObj,void 0,c):this.finalizeText(d,this.prevTextObj):"undefined"!=typeof c?this.finalizeText(d,this.prevTextObj,a,c):this.finalizeText(d,
this.prevTextObj,a);vApp.wb.obj.drawTextObj.wmode=!1}},finalizeText:function(b,a,d,c){d=vApp.wb.vcan;var e=document.getElementById(a.id),g="";if("undefined"==typeof c){c=e.getElementsByTagName("textarea");for(var f=0;f<c.length;f++)if(c[f].id==e.id+"textarea"){g=c[f].value;break}}else g=c;b.font="20px Times New Roman";var n=0,m=g.split(/\r?\n/),n=b.measureText(m[0]).width;c=15;for(f=1;f<m.length;f++){c+=15;var l=b.measureText(m[f]).width;l>n&&(n=l)}n/=2;f=(new Date).getTime();b={type:"text",text:g,
x:a.measure.x+n,y:a.measure.y+c,fontSize:20,fontWidth:b.measureText(g).width,mp:{x:a.measure.x,y:a.measure.y}};!1==vApp.wb.obj.drawTextObj.muser&&(g={mt:f,ac:"d",x:this.startPosX,y:this.startPosY,mtext:b.text},vApp.wb.uid++,g.uid=vApp.wb.uid,d.main.replayObjs.push(g),vApp.storage.store(JSON.stringify(d.main.replayObjs)),vApp.storage.wholeStore(g),vApp.wb.utility.beforeSend({repObj:[g]}),vApp.wb.utility.updateSentPackets(g));b=vApp.wb.canvas.readyObject(b);vApp.wb.canvas.addObject(b);d.main.children[d.main.children.length-
1].mt=f;e.parentNode.removeChild(a);d.renderAll();0<vApp.wb.sentPackets&&null!=document.getElementById(vApp.wb.sentPackDiv)&&(document.getElementById(vApp.wb.sentPackDiv).innerHTML=vApp.wb.sentPackets)}}}})(window);(function(f){f.keyBoard={prvTool:"",skey:!1,triggerActiveAll:function(b){b.shiftKey&&(console.log("what happend mere bhai"),vApp.wb.keyBoard.skey=!0,vApp.wb.keyBoard.prvTool=vApp.wb.tool.cmd,vApp.wb.toolInit("t_activeall"),b={cmd:"t_activeall",mt:(new Date).getTime()},vcan.main.replayObjs.push(b),vApp.wb.utility.beforeSend({repObj:[b]}),vApp.wb.vcan.main.action="move")},triggerdeActiveAll:function(b){vApp.wb.keyBoard.skey&&(console.log("what happend mere bhai ddd"),b=(new Date).getTime(),vApp.wb.utility.deActiveFrmDragDrop(),
...
3;b.height=this.height;b.id="graphCanvas";a.style.position="relative";b.style.position="absolute";b.style.left=0;b.style.top=0;a.appendChild(b)}}},ab2str:function(a){return String.fromCharCode.apply(null,new Int8Array(a))},str2ab:function(a){for(var b=new ArrayBuffer(a.length),b=new Int8Array(b),c=0,e=a.length;c<e;c++)b[c]=a.charCodeAt(c);return b},recorderProcess:function(a){(new Date).getTime();console.log("out of recording");repMode||(console.log("Audio recording"),this.calcAverage(),a=a.inputBuffer.getChannelData(0),
a=this.resampler.resampler(a),this.recordAudio||(this.recordingLength+=this.bufferSize),a=this.audioInLocalStorage(a),vApp.wb.utility.beforeSend({audioSamp:a}))},audioInLocalStorage:function(a){a=convertFloat32ToInt16(a);a=G711.encode(a,{alaw:"alaw"==this.encMode?!0:!1});a=this.ab2str(a);a=LZString.compressToBase64(a);vApp.storage.audioStore(JSON.stringify(a));return a},calcAverage:function(){var a=new Uint8Array(analyser.frequencyBinCount);analyser.getByteFrequencyData(a);for(var b=0,c=a.length,
e=0;e<c;e++)b+=a[e];this.graph.average=b/c},audioInGraph:function(){var a=cthis.video;if("t"==vApp.gObj.uRole){var b=this.graph.height-this.graph.height*this.graph.average/100;a.tempVidCont.beginPath();a.tempVidCont.moveTo(a.tempVid.width-this.graph.width,this.graph.height);a.tempVidCont.lineTo(a.tempVid.width-this.graph.width,b);a.tempVidCont.lineWidth=this.graph.width;a.tempVidCont.strokeStyle="rgba(247, 25, 77, 1)";a.tempVidCont.closePath();a.tempVidCont.stroke()}},play:function(a,b,c){a=LZString.decompressFromBase64(a);
a=this.str2ab(a);a=G711.decode(a,{alaw:"alaw"==this.encMode?!0:!1,floating_point:!0,Eight:!0});b=this.Html5Audio.audioContext.currentTime+b;var e=this.Html5Audio.audioContext.createBuffer(1,a.length,8E3);e.getChannelData(0).set(a);a=this.Html5Audio.audioContext.createBufferSource();a.buffer=e;a.connect(this.Html5Audio.audioContext.destination);a.start(b,c)},replayInit:function(){vApp.storage.getAllObjs(["audioData"],function(){vApp.gObj.video.audio.replay(0,0)})},replay:function(a,b){repMode=!0;var c,
e,f;0<this.audioNodes.length&&(c=this.mergeBuffers(this.audioNodes),e=this.Html5Audio.audioContext.currentTime+a,f=this.Html5Audio.audioContext.createBuffer(1,c.length,7800),f.getChannelData(0).set(c),c=this.Html5Audio.audioContext.createBufferSource(),c.buffer=f,c.connect(this.Html5Audio.audioContext.destination),c.start(e,b))},mergeBuffers:function(a){for(var b=new Float32Array(this.recordingLength),c=0,e=a.length,f=0;f<e;f++){var h=a[f];console.log("bf Length "+h.length);b.set(h,c);c+=h.length}return b},
assignFromLocal:function(a,b){this.init();for(var c=0;c<a.length;c++){var e=LZString.decompressFromBase64(a[c]),e=this.str2ab(e);samples=G711.decode(e,{alaw:"alaw"==this.encMode?!0:!1,floating_point:!0,Eight:!0});this.audioNodes.push(new Float32Array(samples));this.recordingLength+=16384}"undefined"!=typeof b&&b()},manuPulateStream:function(){var a=cthis.stream;vApp.vutil.chkValueInLocalStorage("recordStart")?vApp.wb.recordStarted=localStorage.getItem("recordStart"):(vApp.wb.recordStarted=(new Date).getTime(),
localStorage.setItem("recordStart",vApp.wb.recordStarted));var b=new (f.AudioContext||f.webkitAudioContext||f.mozAudioContext);analyser=b.createAnalyser();a=b.createMediaStreamSource(a);cthis.audio.bufferSize=16384;cthis.audio.rec=b.createScriptProcessor(cthis.audio.bufferSize,1,1);cthis.audio.initAudioNode();cthis.audio.rec.onaudioprocess=cthis.audio.recorderProcess.bind(cthis.audio);a.connect(analyser);analyser.connect(cthis.audio.rec);cthis.audio.rec.connect(b.destination)},initAudioNode:function(){(new Date).getTime()},
updateInfo:function(){this.audioStreamArr=[];vApp.wb.pageEnteredTime=vApp.wb.recordStarted=(new Date).getTime();repMode=this.recordAudio=!1}},video:{width:75,height:56,tempVid:"",tempVidCont:"",myVideo:"",remoteVid:"",remoteVidCont:"",maxHeight:250,init:function(){cthis.video.tempVid=document.getElementById("tempVideo");cthis.video.tempVid.width=cthis.video.width;cthis.video.tempVid.height=cthis.video.height;cthis.video.tempVidCont=cthis.video.tempVid.getContext("2d");this.videoCont=document.getElementById("allVideosCont");
this.videoCont.style.maxHeight=this.maxHeight+"px"},calcDimension:function(){this.myVideo.width=this.width;this.myVideo.height=this.height},removeUser:function(a){a=document.getElementById("user"+a);null!=a&&a.parentNode.removeChild(a)},createElement:function(a){var b=document.createElement("div");b.className="videoWrapper";var c=document.createElement("div");c.className="videoSubWrapper";c.id="user"+a.id;c.setAttribute("data-uname",a.name);b.appendChild(c);vidId=a.id;var e=document.createElement("canvas");
e.id="video"+vidId;e.className="userVideos";e.width=this.width;e.height=this.height;var f=this.videoCont;"undefined"==typeof f&&(f=document.getElementById("allVideosCont"));var h=f.offsetHeight;c.appendChild(e);a.hasOwnProperty("role")&&"t"==a.role?f.insertBefore(b,f.firstChild):f.appendChild(b);a=f.offsetHeight;a!=h&&"undefined"!=typeof cthis&&cthis.video.updateHightInSideBar(a);"undefined"!=f.style.overflowY&&"scroll"!=f.style.overflowY&&(f.style.overflowY="scroll",document.getElementById(vApp.gObj.chat.mainChatBoxId).style.borderTop=
"3px solid #bbb")},updateHightInSideBar:function(a){var b=document.getElementById("widgetRightSide").offsetHeight;document.getElementById("chatContainer").style.height=b-a+"px"},send:function(){var a=this,b;setInterval(function(){if("t"==vApp.gObj.uRole){if("undefined"==typeof c){var c=document.getElementById("graphCanvas");cthis.audio.graph.cvCont=c.getContext("2d")}cthis.audio.graph.cvCont.clearRect(0,0,c.width,c.height)}a.tempVidCont.clearRect(0,0,a.tempVid.width,a.tempVid.height);a.tempVidCont.drawImage(a.myVideo,
0,0,a.width,a.height);"t"==vApp.gObj.uRole&&cthis.audio.graph.display();b=a.tempVid.toDataURL("image/jpg",.3);c={name:vApp.gObj.uName,id:vApp.gObj.uid};"t"==vApp.gObj.uRole&&(c.role=vApp.gObj.uRole);vApp.wb.utility.beforeSend({user:c,videoByImage:b})},1E3)},startToStream:function(){cthis.video.calcDimension();cthis.video.send()},playWithoutSlice:function(a){var b=a.videoByImage,c=new Image;c.src=b;this.remoteVid=document.getElementById("video"+a.user.id);this.remoteVidCont=this.remoteVid.getContext("2d");
var e=this;c.onload=function(){e.remoteVidCont.drawImage(this,0,0)}},justForDemo:function(){var a=0,b=document.getElementById("allVideosCont");b.style.maxHeight="250px";setInterval(function(){if(20>=++a){b=document.getElementById("allVideosCont");var c=document.createElement("div");c.className="videoWrapper";var e=document.createElement("div");e.className="videoSubWrapper";e.setAttribute("data-uname","suman"+a);c.appendChild(e);var f=b.offsetHeight,h=document.createElement("video");h.className="userVideo";
h.src="http://html5demos.com/assets/dizzy.mp4";e.appendChild(h);b.appendChild(c);c=b.offsetHeight;c!=f&&cthis.video.updateHightInSideBar(c);250<=b.offsetHeight&&"undefined"!=b.style.overflowY&&"scroll"!=b.style.overflowY&&(b.style.overflowY="scroll",document.getElementById(vApp.gObj.chat.mainChatBoxId).style.borderTop="3px solid #bbb")}},200)}},init:function(a){cthis=this;vcan.oneExecuted=!0;a={audio:!0,video:!0};cthis.video.init();vApp.adpt=new vApp.adapter;vApp.adpt.init(navigator).getUserMedia(a,
this.handleUserMedia,this.handleUserMediaError);vApp.system.wbRtc.peerCon&&"undefined"==typeof localStorage.wbrtcMsg&&(vApp.wb.view.multiMediaMsg("WebRtc"),localStorage.wbrtcMsg=!0)},handleUserMedia:function(a){cthis.audio.init();cthis.video.myVideo=document.getElementById("video"+vApp.gObj.uid);vApp.adpt.attachMediaStream(cthis.video.myVideo,a);cthis.video.myVideo.muted=!0;a.ontimeupdate=function(){console.log("raja"+a.currentTime)};"t"==vApp.gObj.uRole&&(cthis.stream=a,cthis.audio.manuPulateStream(),
...
replayObj:function(b){f.vApp.wb.vcan.main.replayObjs=[];0<b.length&&vApp.wb.gObj.displayedObjId+1==b[0].uid&&(f.vApp.wb.vcan.main.replayObjs=b,vApp.wb.toolInit("t_replay","fromBrowser",!0,vApp.wb.utility.dispQueuePacket))},chunk:function(b,a,d){vApp.wb.bridge.handleMissedPackets(b,a,d)},repObjForMissedPkts:function(b){(0!=vApp.wb.gObj.rcvdPackId||0<vApp.wb.uid&&0==vApp.wb.gObj.rcvdPackId)&&("object"==typeof b||b instanceof Array)&&b[0].hasOwnProperty("uid")&&vApp.wb.gObj.rcvdPackId+1!=b[0].uid&&!b.hasOwnProperty("chunk")&&
