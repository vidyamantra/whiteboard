...
e+" : "+d[e]+" <br />";null!=document.getElementById("sentMsgInfo")&&(document.getElementById("sentMsgInfo").innerHTML=c)}},audioSend:function(b){1==io.sock.readyState&&io.sendBinary(b)},beforeSend:function(b){var a=JSON.stringify(b);b.hasOwnProperty("createArrow")?vApp.wb.vcan.optimize.sendPacketWithOptimization(a,io.sock.readyState,100):(vApp.wb.sentPackets+=a.length,1==io.sock.readyState&&io.send(b),JSON.parse(a).hasOwnProperty("repObj")&&vApp.wb.utility.updateSentInformation(a));localStorage.sentPackets=
vApp.wb.sentPackets},checkCanvasHasParents:function(){for(var b=document.getElementById("vcanvas");"BODY"!=b.parentNode.tagName;)"vcanvas"!=b.id&&(b.style.margin="0",b.style.padding="0"),b=b.parentNode;"vcanvas"!=b.id&&(b.style.margin="0",b.style.padding="0")},lockCanvas:function(){if(f.earlierWidth!=f.innerWidth&&(vApp.wb.canvasDisable=!0,vApp.wb.utility.makeCanvasDisable(),vApp.wb.utility.toolWrapperDisable(),null==document.getElementById("divForReloadMsg"))){var b=null!=localStorage.getItem("teacherId")?
"msgForReload":"msgStudentForReload";f.vApp.wb.view.displayMsgBox("divForReloadMsg",b);f.earlierWidth=f.innerWidth}},getElementRightOffSet:function(b){var a=20;null!=b.parentNode&&(b=b.parentNode,a=vcan.utility.getElementOffset(b),a=f.innerWidth-(b.clientWidth+(a.x-0)));return a},initUpdateInfo:function(b){b=vApp.wb.receivedPackets;setInterval(function(){null!=document.getElementById(vApp.wb.receivedPackDivPS)&&(b=vApp.wb.utility.calcPsRecvdPackets(b),document.getElementById(vApp.wb.receivedPackDiv).innerHTML=
...
(this.recordingLength+=this.bufferSize);a=this.audioInLocalStorage(a);var b=0,c=0;for(i=0;i<a.length;i++){var e=Math.abs(a[i]);b<e&&(b=e);64<e&&c++}(127<b||1400<c)&&vApp.wb.utility.audioSend(a)}},audioInLocalStorage:function(a){a=convertFloat32ToInt16(a);return G711.encode(a,{alaw:"alaw"==this.encMode?!0:!1})},calcAverage:function(){var a=new Uint8Array(analyser.frequencyBinCount);analyser.getByteFrequencyData(a);for(var b=0,c=a.length,e=0;e<c;e++)b+=a[e];this.graph.average=b/c},audioInGraph:function(){var a=
...
document.getElementById("video"+a.user.id);this.remoteVidCont=this.remoteVid.getContext("2d");var e=this;c.onload=function(){e.remoteVidCont.drawImage(this,0,0)}},justForDemo:function(){var a=0,b=document.getElementById("allVideosCont");b.style.maxHeight="250px";setInterval(function(){if(20>=++a){b=document.getElementById("allVideosCont");var c=document.createElement("div");c.className="videoWrapper";var e=document.createElement("div");e.className="videoSubWrapper";e.setAttribute("data-uname","suman"+
a);c.appendChild(e);var f=document.createElement("video");f.className="userVideo";f.src="http://html5demos.com/assets/dizzy.mp4";e.appendChild(f);b.appendChild(c);250<=b.offsetHeight&&"undefined"!=b.style.overflowY&&"scroll"!=b.style.overflowY&&(b.style.overflowY="scroll",document.getElementById(vApp.gObj.chat.mainChatBoxId).style.borderTop="3px solid #bbb")}},200)},createVideoElement:function(){var a=document.createElement("div");a.className="videoWrapper";var b=document.createElement("div");b.className=
"videoSubWrapper";a.appendChild(b);var c=document.createElement("video");c.id="video"+vApp.gObj.uid;c.autoplay=!0;b.appendChild(c);return a},imageReplaceWithVideo:function(a,b){var c=document.getElementById("ml"+a).getElementsByTagName("a")[0],e=c.getElementsByTagName("img")[0];c.replaceChild(b,e)},insertTempVideo:function(a){var b=document.createElement("canvas");b.id="tempVideo";a.parentNode.insertBefore(b,a)},tempVideoInit:function(){cthis.video.tempVid=document.getElementById("tempVideo");cthis.video.tempVid.width=
...
vApp.wb.utility.userIds=[];cthis.sendMessage("bye");b.disconnect()}})(window);(function(f){var b={requestPackets:function(a){1<a.length&&(vApp.wb.gObj.myArr=a);vApp.wb.sentReq=!0;return[vApp.wb.gObj.rcvdPackId,a[0].uid]},makeQueue:function(a){vApp.wb.gObj.rcvdPackId!=vApp.wb.gObj.displayedObjId&&(vApp.wb.gObj.packQueue=vApp.wb.gObj.packQueue.concat(a.message.repObj))},sendPackets:function(a,b){if(0==a.message.getMsPckt[0])var c=-1;else for(c=0;c<vApp.wb.gObj.myrepObj.length&&a.message.getMsPckt[0]!=vApp.wb.gObj.myrepObj[c].uid;c++);for(c+=1;c<a.message.getMsPckt[1];c++)b.push(vApp.wb.gObj.myrepObj[c]);
